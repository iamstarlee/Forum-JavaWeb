...
<body>
	<div id="content">
		<div id="postDiv">
			...
			<div id="topRight">
				<h3 id="info">
					<img src="images/new.png" width="22" height="22">&nbsp;最新发表
				</h3>
				<div class="list-group">
			...
			<div id="topRight">
				<h3 id="info">
					<img src="images/hot.png" width="22" height="22">&nbsp;热搜
				</h3>
				<div class="list-group">
				...
				<div id="themes"
					...
					<div>
						<a
							...
							face="楷体" size="4">${type.name} 类</font><br> <br> <font
							face="楷体" size="4">浏览量：${type.count}</font> </a>
					</div>
				</div>
			</c:forEach>
		</div>
