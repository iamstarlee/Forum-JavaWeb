...
<script type="text/javascript">
	...
	function add() {
		...
		$.ajax({
			...
			error : function(data) {
				alert("请求失败");
				window.location.href = "ThemeServlet";//请求失败返回商城
			},
		});
	}
</script>
...
<body onload="setMessage()">
	<div id="back" userID=<%=userID %>>
		<div class='panel panel-primary' id="topBar">
			<div class='panel-heading'>发表课程</div>
		</div>
		<div id="connent">
			<div id="postPanel">
				<div class="form-group">
					<b style="color:#0088D8; font-size:24px">标题</b> <input id="title"
						...
						<option selected value='16'>数学</option>
						<option value='17'>物理</option>
						<option value='18'>英语</option>
						<option value='19'>化学</option>
						<option value='20'>计算机</option>
					</select>
				</div>
