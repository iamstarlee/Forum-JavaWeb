	...
	window.onload = function() {
		...
		password.onblur = function() {
			...
			//长度少于2个汉字或字母
				...
				password1_msg.innerHTML = "ps:长度少于10！";
			}
			//验证通过
			else {
			...
			$.ajax({
				...
				success : function(value) {
					...
					if (value.result == "登入成功") {
						...
						$("#userBox")
								.html(
										"<div><img class='img-circle' class='img-cricle' style='width:40px; height:40px; margin-right:20px' alt='140x140' src='"+userPhoto+"'/>"
...
<body>
	<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"
		...
		<div class="navbar-header">
			<a href="##" class="navbar-brand title">StarLee</a>
		</div>
		<ul class="nav nav-pills pull-left">
			<li onClick="addClass_(e)"><a id="linkText" href="home.jsp" target="content"
				id="navBar1" onClick="bar()">首页</a></li>
			<li onClick="addClass_()"><a id="linkText2" href="ThemeServlet"
				target="content" id="navBar2">广场中心</a>
			</li>
			<li onclick="addClass_()"><a id="linkText3" href="search.jsp" target="content"
				id="navBar3">搜搜一下</a></li>
			<li onclick="addClass_()"><a id="linkText4" href="aboutUs.jsp" target="content"
				id="navBar6">关于我们</a>
			</li>
		</ul>
		...
		<div class="pull-right" id="userBox"
			...
			&nbsp; &nbsp; &nbsp; &nbsp; <a class="btn btn-primary theme-login"
				id="login" href="javascript:;">登入</a> <a
			...
			<div class="theme-signin">
				...
				<div style="margin-top:20px">
					<input class="btn btn-primary" type="button" onClick="login()"
						value=" 登 入 " style="margin-left: 0px;" /> <input
