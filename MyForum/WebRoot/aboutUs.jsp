...
#right{
  ...
  <div>
  <div id="left">
  <h3>&nbsp;&nbsp;<font color="#224E73">河南工业大学是博客园的运行公司，具体地址：</font></h3>
  <p>&nbsp;&nbsp;&nbsp;<img src="images/haut.jpg" width="534" height="310">
  <br>
  <br>
  <br>
  ...
  <p style="margin-left:40px"><font color="#224e73">客服邮箱：kefu@cnblog.com</font></p>
  <br>
  <h3 style="margin-left:40px"><font color="#224e73">媒体采访:</font></h3>
  <p style="margin-left:40px"><font color="#224e73">媒体采访邮箱：PR@cnblog.com</font></p>
  <br>
  <h3 style="margin-left:40px"><font color="#224e73">市场合作:</font></h3>
  <p style="margin-left:40px"><font color="#224e73">网络推广合作邮箱：MKT@cnblog.com</font></p>
  <br>
  <h3 style="margin-left:40px"><font color="#224e73">战略发展:</font></h3>
  <p style="margin-left:40px"><font color="#224e73">金融产品合作邮箱：BD@cnblog.com</font></p>
 
  </div>
  
  <div id="right">
  <h3 style="margin-left:70px"><font color="#224e73">公司总部:</font></h3>
  <p style="margin-left:70px"><font color="#224e73">地址：河南省郑州市河南工业大学莲花街校区100号</font></p>
  <p style="margin-left:70px"><font color="#224e73">电话：123456789&nbsp;&nbsp;&nbsp;123456789</font></p>
  ...
  <p style="margin-left:70px"><font color="#224e73">登录博客园官网（http://www.cnblog.com),有cnblog团队在线为您提供帮助；</font></p>
  <p style="margin-left:70px"><font color="#224e73">关注博客园新浪微博（http://e.cnblog.com/cnblog),与我们互动提出宝贵意见；</font></p>
  <p style="margin-left:70px"><font color="#224e73">关注博客园微信（微信号：cnblog),了解更多理财咨询。</font></p>
  <br><br><br><br>
  ...
  <p style="margin-left:40px"><font color="#224e73">客服邮箱：<b>kefu@cnblog.com</b></font></p>
