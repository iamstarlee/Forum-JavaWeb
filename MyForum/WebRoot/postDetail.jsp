...
<script type="text/javascript">
	...
	function getData(value) {
		...
		var Rtime = formatTime(post[0].publishTime.time,'Y/M/D h:m:s');
		var html = "<div><font size='3px' color='#0088D8'><b>当前位置 &nbsp;&nbsp;>>>&nbsp;&nbsp;帖子详情</b></font><br/><br/></div>"
				+ "<div class='panel panel-primary'>"
				+ "<div class='panel-heading'>"
				+ "<img class='img-circle' style='width:30px; height:30px; float:left; margin-right:10px;' src='http://localhost:8080/MyForum_war_exploded/" + post[0].userPhoto +"'/>"
				+ "<div id='title'>"
				+ post[0].title
				+ "</div>"
				+ "<div id='addPostBtn'>"
	...
	function setComments(value) {
		...
		if (state == "success") {
			...
			for ( var i = 0; i < obj.length; i++) {
				...
				var Rtime = formatTime(obj[i].commentTime.time,'Y/M/D h:m:s');
				str += "<div class='panel panel-info'>"
						+ "<div class='panel-heading'>"
						+ "<img class='img-circle' style='width:30px; height:30px; float:left; margin-right:50px' src='http://localhost:8080/MyForum_war_exploded/" + obj[i].userPhoto +"'/>"
