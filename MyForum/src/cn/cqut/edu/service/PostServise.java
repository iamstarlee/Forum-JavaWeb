...
public class PostServise {
	...
	public int deletePost(int postID) {
		String sql = "delete from comment where post = ?";
		int rs = dao.executeUpdate(sql, new Object[]{postID});
		System.out.println("delete by prep "+rs);
	
		String sql2 = "delete from post where postID = ?";
		int rs2 = dao.executeUpdate(sql2, new Object[]{postID});
		return rs2;
	}
	...
	public int addPost(int userID, int postType, String title, String content) {
		...
		String sql = "insert into post (title, content, publishTime, operator, type,pageview) values (?,?,?,?,?,0)";
