...
public class HeadImage extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String savePath = getServletContext().getRealPath("/images/head");//图片读取的路径
		System.out.printf("the server's path is " +  savePath);
		...
		try {
			...
			System.out.println(photoPathNew);
			String rePath = photoPathNew.substring(46);

			String rePath1 = "images/head/"+photoName;
			int res = servise.updatePhoto(Integer.parseInt(userID), rePath1);
			if (res == 1) {
